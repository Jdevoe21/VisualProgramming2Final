 ...
 * @author Jack
 */
public class DigitalWriteBlock extends FunctionBlock{
    
    public DigitalWriteBlock(int x, int y, boolean isToolbarBlock){
        super("digitalWrite", Color.BLUE, x, y, isToolbarBlock);
    ...
    public Block spawn(BlockContainer container){
        Block temp1 = new DigitalWriteBlock(x, y, false);
